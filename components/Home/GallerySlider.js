...
const GallerySlider = () => {
  ...
  return (
    <section className="py-20 bg-[#F1F5F9] relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="relative">
          ...
          {/* Custom Arrows */}
          <div className="custom-prev absolute left-0 top-1/2 -translate-y-1/2 w-12 h-12 flex items-center justify-center bg-white rounded-full shadow-lg cursor-pointer z-50 hover:bg-gray-100 transition-colors">
            <svg
          ...
          <div className="custom-next absolute right-0 top-1/2 -translate-y-1/2 w-12 h-12 flex items-center justify-center bg-white rounded-full shadow-lg cursor-pointer z-50 hover:bg-gray-100 transition-colors">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="w-6 h-6 text-gray-800"
              fill="none"
